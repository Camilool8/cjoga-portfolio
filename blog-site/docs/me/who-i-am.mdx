...
import Timeline, { TimelineEntry } from '@site/src/components/Timeline';
...
<Timeline caption="The short version">
  <TimelineEntry
    year="Feb 2002"
    title="Born in Santo Domingo, Dominican Republic"
  />
  <TimelineEntry
    year="2019"
    title="Started Computer Science at PUCMM"
  />
  <TimelineEntry
    year="2020 – 2022"
    title="Call-center jobs, then junior DBA at a car insurer"
  />
  <TimelineEntry
    year="Apr 2022"
    title="Hired by Shadow-Soft (now Arctiq) — the start of DevOps work"
  />
  <TimelineEntry
    year="2024"
    title="Graduated PUCMM · capstone on neural-network fruit ripeness"
  />
  <TimelineEntry
    year="2025"
    title="Co-founded KODEPULL SRL with Fernando Reyes"
  />
  <TimelineEntry
    year="Today"
    title="DevOps Engineer in Santo Domingo — Arctiq, INSPYR, KodePull"
    emphasis
  />
</Timeline>
