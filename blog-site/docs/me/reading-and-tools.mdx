...
<TechStackGrid
  caption="Diagrams as code"
  compact
  items={['D2']}
/>

[D2](https://d2lang.com/) is my new default for architecture diagrams — text in, clean SVG out, diffable in a merge request like everything else. I picked it up this year documenting EKS infrastructure and it stuck.
