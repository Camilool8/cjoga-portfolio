  ...
  return (
    <div className="min-h-screen bg-light-primary dark:bg-dark-primary py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {error && (
          <div className="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-200 p-4 rounded-md mb-6">
            {error}
          </div>
        )}

        {success && (
          <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-200 p-4 rounded-md mb-6">
            {success}
          </div>
        )}
        ...
        {loading && !isEditMode ? (
          <div className="flex justify-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-light-accent dark:border-teal-500"></div>
          </div>
        ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-light-secondary dark:bg-gray-800 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label
                        htmlFor="title"
                        className="block text-sm font-medium text-light-text-secondary dark:text-gray-300 mb-1"
                      >
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 border-2 border-light-secondary dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-light-accent dark:focus:ring-teal-500 focus:border-transparent bg-light-primary dark:bg-gray-700 text-light-text-primary dark:text-white"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      <p className="mt-1 text-xs text-light-text-secondary dark:text-gray-400">
                      ...
                      {coverImage ? (
                        <div className="mb-3 relative">
                          ...
                          <button
                            ...
                            className="absolute top-2 right-2 bg-red-500 dark:bg-red-600 text-white rounded-full p-2 hover:bg-red-600 dark:hover:bg-red-700"
                    ...
                    <div>
                      ...
                      <div className="flex">
                        <input
                          ...
                          className="flex-1 px-4 py-2 border-2 border-light-secondary dark:border-gray-600 rounded-l-md focus:outline-none focus:ring-2 focus:ring-light-accent dark:focus:ring-teal-500 focus:border-transparent bg-light-primary dark:bg-gray-700 text-light-text-primary dark:text-white"
                          placeholder={t("admin.postEditor.tagsPlaceholder")}
                        />
                        <button
                          type="button"
                          onClick={handleAddTag}
                          className="bg-light-accent dark:bg-teal-600 text-white px-4 py-2 rounded-r-md hover:bg-light-accent/90 dark:hover:bg-teal-500"
                        >
                          <FaPlus />
                        </button>
                      </div>
                      <div className="flex flex-wrap gap-2 mt-2">
                        {tags.map((tag) => (
                          <div
                            key={tag}
                            className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-light-primary dark:bg-gray-700 text-light-accent dark:text-teal-300 border border-light-accent/20 dark:border-teal-500/30"
                          >
                            ...
                            <button
                              ...
                              className="ml-1 text-light-text-secondary dark:text-gray-300 hover:text-red-500 dark:hover:text-red-300"
                            >
                              <FaTimes />
                            </button>
                          </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-light-accent dark:text-teal-500 focus:ring-light-accent dark:focus:ring-teal-500 rounded border-light-secondary dark:border-gray-600"
                      />
                      <label
                        htmlFor="published"
                        className="ml-2 block text-sm text-light-text-primary dark:text-white"
                      >
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    disabled={loading}
                    className={`bg-light-accent dark:bg-teal-600 text-white py-2 px-6 rounded-md font-medium flex items-center transition-colors ${
                      loading
                        ? "opacity-70 cursor-not-allowed"
                        : "hover:bg-light-accent/90 dark:hover:bg-teal-500"
                    }`}
                  >
                    {loading ? (
                      <>
            ...
            {showPreview && (
              <div className="lg:col-span-2">
                <div className="bg-light-secondary dark:bg-gray-800 rounded-lg p-6 sticky top-24">
                  ...
                  <div className="bg-light-primary dark:bg-gray-700 rounded-lg p-6 overflow-auto max-h-[calc(100vh-200px)]">
                    <h1 className="text-2xl font-bold mb-4 text-light-text-primary dark:text-white">
                    ...
                    {tags.length > 0 && (
                      <div className="flex flex-wrap gap-2 mb-4">
                        {tags.map((tag) => (
                          <div
                            key={tag}
                            className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-light-secondary dark:bg-gray-800 text-light-accent dark:text-teal-300"
                          >
                            <FaTag className="mr-1 text-xs" />
                            {tag}
                          </div>
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none prose-a:text-light-accent dark:prose-a:text-teal-300 prose-img:rounded-md prose-headings:scroll-mt-24">
